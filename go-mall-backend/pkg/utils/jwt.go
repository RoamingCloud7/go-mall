...
// This struct defines the custom claims to include in the JWT.
type Claims struct {
	ID        uint   `json:"id"`
...
// Generates a JWT token with the specified user details.
...
// If valid, it returns the claims embedded in the token.
